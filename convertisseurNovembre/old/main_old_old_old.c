...
int main(void)
{
    ...
    int choice; // choice est utilisé pour différents choix (économie de RAM)
    while(stay.i){
        ...
        //Boolean dispsubmenu; // Booléen qui indique si l'on veut afficher un sous-menu
        //dispsubmenu.i=BTRUE; // Permet d'accéder aux sous-menus (sinon ne rentrerai pas dans le while)
        switch(choice){
            case 0 :
